...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'business-metrics', label: '运营指标', to: '/business-metrics', icon: Activity },
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ collapsed = false, onNavigate }) => {
  ...
  return (
    <div className="flex flex-col">
      <div className={cn('mb-4 flex shrink-0 items-center gap-2 px-1', collapsed ? 'justify-center' : '')}>
      ...
      {authEnabled ? (
        <button
          ...
          className={cn(
            'mt-5 flex h-11 w-full shrink-0 cursor-pointer select-none items-center gap-3 rounded-2xl border border-transparent px-3 text-sm text-secondary-text transition-all hover:border-border/70 hover:bg-hover hover:text-foreground',
