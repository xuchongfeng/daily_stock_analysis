...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_MODEL": {
        "title": "Primary Model",
        "description": "Primary model in provider/model format (e.g. gemini/gemini-3-flash-preview, deepseek/deepseek-v4-pro, anthropic/claude-3-5-sonnet-20241022). If empty, it is auto-inferred from available API keys or channel declarations.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "DEEPSEEK_API_KEY": {
        ...
        "description": "Official DeepSeek API key (from https://platform.deepseek.com). Auto-infers deepseek/deepseek-v4-pro when set alone (no LITELLM_MODEL). Also works in multi-channel mode.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "TOP_MOVERS_ENABLED": {
        "title": "Market Scanner Enabled",
        "description": "When true, scheduled/GitHub workflows may run market-scanner batches (CLI: python main.py --market-scan always runs regardless).",
        "category": "market_scan",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_LIMIT": {
        "title": "Scanner Top-N Limit",
        "description": "Max symbols per batch for gainers (by change %) and volume scans (max 1000).",
        "category": "market_scan",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_MAX_WORKERS": {
        "title": "Scanner Max Workers",
        "description": "Thread pool size for concurrent analysis in market scanner batches.",
        "category": "market_scan",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_REPORT_TYPE": {
        "title": "Top Movers Report Type",
        "description": "Report type for top movers batch: simple, brief, or full.",
        "category": "market_scan",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "simple",
        "options": ["simple", "brief", "full"],
        "validation": {},
        "display_order": 40,
    },
    "TOP_MOVERS_NOTIFY_ENABLED": {
        "title": "Top Movers Notify",
        "description": "Send one summary notification after the batch completes.",
        "category": "market_scan",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_NOTIFY_TOP_K": {
        "title": "Top Movers Notify Top K",
        "description": "How many highest sentiment-score names to include in the summary notification.",
        "category": "market_scan",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_EXCLUDE_ST": {
        "title": "Top Movers Exclude ST",
        "description": "Exclude names starting with ST or *ST from the universe.",
        "category": "market_scan",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TOP_MOVERS_DEDUPE_WATCHLIST": {
        "title": "Top Movers Dedupe Watchlist",
        "description": "Skip symbols that are already in STOCK_LIST for this run.",
        "category": "market_scan",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
